...
/**
 * Field-level validation messages are keys, not copy: react-hook-form renders
 * them through <FormMessage>, which resolves them against the `login`
 * namespace. Keeping them as keys is what lets the schema live at module
 * scope, outside any component that could call a hook.
 */
